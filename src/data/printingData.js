...
export const PRINTERS = [
  ...
  },
  {
    ...
    notes: "OPEN MATERIAL SYSTEM — compatible with multiple third-party resins (Crowntec, VarseoSmile Crown Plus, KeySplint, etc.). Key advantage for practices wanting material flexibility without vendor lock-in.\n\nUsed extensively in research for printing definitive crown resins. Good accuracy for orthodontic models per Venezia 2022.",
    refs: ["hegedus-2025-survey"]
  },
];
