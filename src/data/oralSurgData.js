...
export const FORCEPS = [
  {
    id: "upper-universal-150", lastReviewed: "2026-03", name: "Upper Universal Forceps (150)", mfr: "N/A — Instrument", cat: "Forceps — Maxillary",
  ...
  {
    id: "lower-universal-151", lastReviewed: "2026-03", name: "Lower Universal Forceps (151)", mfr: "N/A — Instrument", cat: "Forceps — Mandibular",
  ...
  {
    id: "cow-horn-17", lastReviewed: "2026-03", name: "Cow Horn Forceps (17/23)", mfr: "N/A — Instrument", cat: "Forceps — Mandibular Molar",
  ...
  {
    id: "physics-forceps", lastReviewed: "2026-03", name: "Physics Forceps", mfr: "GoldenDent", cat: "Forceps — Atraumatic",
  ...
  {
    id: "elevators-straight-cryer", lastReviewed: "2026-03", name: "Straight & Cryer Elevators", mfr: "N/A — Instruments", cat: "Elevator — Luxation",
...
export const SURGICAL_TECHNIQUES = [
  {
    id: "coronectomy", lastReviewed: "2026-03", name: "Coronectomy — IAN Protection", mfr: "N/A — Technique", cat: "Surgical Technique — Third Molar",
  ...
  {
    id: "piezosurgery-extraction", lastReviewed: "2026-03", name: "Piezosurgery for Extraction", mfr: "Multiple manufacturers", cat: "Surgical Technique — Piezosurgery",
  ...
  {
    id: "atraumatic-extraction", lastReviewed: "2026-03", name: "Atraumatic Extraction Protocol — Esthetic Zone", mfr: "N/A — Protocol", cat: "Surgical Technique — Atraumatic",
...
export const SOCKET_PRESERVATION = [
  {
    id: "socket-decision-algorithm", lastReviewed: "2026-03", name: "Socket Preservation — Decision Algorithm", mfr: "N/A — Protocol", cat: "Socket Preservation — Decision",
...
export const EXODONTIA_PHARM = [
  {
    id: "analgesic-protocol", lastReviewed: "2026-03", name: "Post-Extraction Analgesic Protocol", mfr: "ADA 2024 Guideline", cat: "Pharmacology — Analgesics",
  ...
  {
    id: "dexamethasone-protocol", lastReviewed: "2026-03", name: "Dexamethasone for Third Molar Surgery", mfr: "N/A — Protocol", cat: "Pharmacology — Dexamethasone",
  ...
  {
    id: "antibiotic-extraction", lastReviewed: "2026-03", name: "Antibiotics for Extraction — When Indicated", mfr: "Cochrane 2021", cat: "Pharmacology — Antibiotics",
...
export const COMPLICATIONS = [
  {
    id: "dry-socket", lastReviewed: "2026-03", name: "Dry Socket (Alveolar Osteitis)", mfr: "N/A — Complication", cat: "Complication — Dry Socket",
  ...
  {
    id: "oac-management", lastReviewed: "2026-03", name: "Oroantral Communication (OAC/OAF)", mfr: "N/A — Complication", cat: "Complication — OAC/OAF",
  ...
  {
    id: "pericoronitis-management", lastReviewed: "2026-03", name: "Pericoronitis — Management Decision Matrix", mfr: "N/A — Protocol", cat: "Complication — Pericoronitis",
