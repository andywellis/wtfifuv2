...
export const ANTICOAG = [
  {
    id: "warfarin-dental", name: "Warfarin (Coumadin) — Dental Management", mfr: "Multiple", cat: "Anticoagulant — Vitamin K Antagonist",
  ...
  {
    id: "antiplatelet-dental", name: "Aspirin & P2Y12 Inhibitors — Dental Management", mfr: "Multiple", cat: "Antiplatelet — Dental Management",
...
export const DIABETES_MEDS = [
  {
    id: "glp1-dental", name: "GLP-1 Agonists (Ozempic, Mounjaro) — ASPIRATION RISK", mfr: "Multiple (semaglutide, tirzepatide, liraglutide)", cat: "Diabetes — GLP-1 Agonist ⚠",
  ...
  {
    id: "insulin-dental", name: "Insulin — Perioperative Management", mfr: "Multiple", cat: "Diabetes — Insulin",
...
export const MRONJ_MEDS = [
  ...
  {
    id: "iv-bisphosphonate", name: "IV Bisphosphonates — Much Higher MRONJ Risk", mfr: "Multiple (Zometa, Reclast)", cat: "Bisphosphonate/Antiresorptive — IV ⚠",
...
export const PSYCH_MEDS = [
  ...
  {
    id: "benzo-chronic-dental", name: "Benzodiazepines (Chronic Use) — Withdrawal Risk", mfr: "Multiple (Xanax, Ativan, Valium, Klonopin)", cat: "Psychiatric — Benzodiazepine",
...
export const SUPPLEMENTS = [
  {
    id: "herbal-supplements", name: "Herbal Supplements — Hold Guidelines", mfr: "SPAQI 2021 Consensus", cat: "Supplement — Herbal ⚠",
  ...
  {
    id: "cannabis-dental", name: "Cannabis/CBD — Perioperative Management", mfr: "ASRA 2023 / SPAQI 2021", cat: "Supplement — Cannabis/CBD ⚠",
...
export const QUICK_REF = [
  {
    id: "drug-interactions-dental", name: "Drug Interactions — Dental Prescribing Quick Reference", mfr: "N/A — Reference", cat: "Quick Reference — Drug Interactions",
  ...
  {
    id: "epi-limits-card", name: "Epinephrine Limits by Medication", mfr: "N/A — Reference", cat: "Quick Reference — Epinephrine",
