...
export const CAMERA_SETTINGS = [
  {
    id: "dslr-settings", lastReviewed: "2026-03", name: "Core DSLR Settings — Manual Mode Protocol", cat: "Camera Settings — Exposure Triangle",
...
export const LENSES = [
  {
    id: "macro-lens-guide", lastReviewed: "2026-03", name: "Macro Lens Selection by Camera Brand & Sensor", cat: "Lens — Brand Recommendations",
...
export const FLASH = [
  {
    id: "flash-selection", lastReviewed: "2026-03", name: "Flash Selection — Ring vs Twin vs Studio", cat: "Flash & Lighting — Clinical Scenarios",
...
export const MIRRORS = [
  {
    id: "photo-mirrors", lastReviewed: "2026-03", name: "Dental Photographic Mirrors — Coatings, Types & Care", cat: "Photographic Mirror — Selection & Care",
...
export const PHOTO_PROTOCOLS = [
  {
    id: "magnification-ratios", lastReviewed: "2026-03", name: "Magnification Ratios — Standardized Views", cat: "Protocol — Magnification Ratios",
  ...
  {
    id: "photo-checklist", lastReviewed: "2026-03", name: "Standard Photo Series — Clinical Documentation Checklist", cat: "Protocol — Shot Checklist",
