...
export const PHILOSOPHIES = [
  {
    id: "abgd-cmorepooope", lastReviewed: "2026-03", name: "ABGD / CMOREPOOOPE Framework", mfr: "American Board of General Dentistry", cat: "Philosophy — Board Standard",
  ...
  {
    id: "kois-risk-based", lastReviewed: "2026-03", name: "Kois Center — Risk-Based Treatment Planning", mfr: "Kois Center (John Kois)", cat: "Philosophy — Risk-Based",
  ...
  {
    id: "spear-esthetics", lastReviewed: "2026-03", name: "Spear Education — Esthetics-Driven", mfr: "Spear Education (Frank Spear)", cat: "Philosophy — Esthetics-Driven",
  ...
  {
    id: "dawson-occlusion", lastReviewed: "2026-03", name: "Dawson Academy — Occlusion-Based", mfr: "Dawson Academy (Peter Dawson)", cat: "Philosophy — Occlusion-Based",
  ...
  {
    id: "pankey-comprehensive", lastReviewed: "2026-03", name: "Pankey Institute — Comprehensive Care", mfr: "Pankey Institute (L.D. Pankey)", cat: "Philosophy — Whole-Patient",
  ...
  {
    id: "global-diagnosis", lastReviewed: "2026-03", name: "Global Diagnosis (Robbins/Rouse)", mfr: "Bill Robbins, Jeff Rouse", cat: "Philosophy — Face-First / Airway",
  ...
  {
    id: "dsd-coachman", lastReviewed: "2026-03", name: "Digital Smile Design (DSD)", mfr: "Christian Coachman", cat: "Philosophy — Digital Visualization",
...
export const CLASSIFICATIONS = [
  {
    id: "asa-classification", lastReviewed: "2026-03", name: "ASA Physical Status Classification (I-VI)", mfr: "American Society of Anesthesiologists", cat: "Classification — Medical Risk",
  ...
  {
    id: "cambra-cra", lastReviewed: "2026-03", name: "CAMBRA Caries Risk Assessment", mfr: "Featherstone / UCSF", cat: "Classification — Caries Risk",
  ...
  {
    id: "aae-pulpal-dx", lastReviewed: "2026-03", name: "AAE Pulpal & Periapical Diagnosis", mfr: "American Association of Endodontists", cat: "Classification — Endodontic Diagnosis",
  ...
  {
    id: "perio-2017-classification", lastReviewed: "2026-03", name: "2017 Periodontal Classification (Stage/Grade)", mfr: "AAP/EFP", cat: "Classification — Periodontal Staging",
  ...
  {
    id: "furcation-classifications", lastReviewed: "2026-03", name: "Furcation Classifications (Glickman/Hamp/Tarnow)", mfr: "Multiple", cat: "Classification — Periodontal Furcation",
  ...
  {
    id: "cairo-recession", lastReviewed: "2026-03", name: "Cairo Recession Classification (RT1-3)", mfr: "Cairo et al. / 2017 Perio Classification", cat: "Classification — Periodontal Recession",
  ...
  {
    id: "dctmd-criteria", lastReviewed: "2026-03", name: "DC/TMD Diagnostic Criteria", mfr: "Schiffman, Ohrbach / RDC/TMD Consortium", cat: "Classification — TMD Diagnosis",
  ...
  {
    id: "pell-gregory-winter", lastReviewed: "2026-03", name: "Pell & Gregory + Winter (Third Molar)", mfr: "Pell & Gregory / Winter / Pederson", cat: "Classification — Third Molar Impaction",
  ...
  {
    id: "kennedy-applegate", lastReviewed: "2026-03", name: "Kennedy Classification + Applegate Rules", mfr: "Kennedy / Applegate", cat: "Classification — Partial Edentulism",
  ...
  {
    id: "siebert-ridge", lastReviewed: "2026-03", name: "Siebert Ridge Defect Classification (I-III)", mfr: "Siebert / Wang & Al-Shammari", cat: "Classification — Ridge Deficiency",
  ...
  {
    id: "mallampati-friedman", lastReviewed: "2026-03", name: "Mallampati Classification (I-IV) + Friedman", mfr: "Mallampati / Friedman / Myers JAMA 2013", cat: "Classification — Airway Assessment",
...
export const SEQUENCING = [
  {
    id: "phased-treatment", lastReviewed: "2026-03", name: "Phased Treatment Model — Universal Sequence", mfr: "N/A — Protocol", cat: "Sequencing — Treatment Phases",
  ...
  {
    id: "ferrule-post-decision", lastReviewed: "2026-03", name: "Ferrule & Post Decision Algorithm", mfr: "N/A — Decision Framework", cat: "Decision — Restorative",
  ...
  {
    id: "nccl-decision", lastReviewed: "2026-03", name: "NCCL Etiology & Management Decision", mfr: "Grippo / Goodacre", cat: "Decision — Restorative",
